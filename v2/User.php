...
<html>
    ...
    <body>
        ...
        <form action="register.php" method="post">
            ...
            <input type="text" id="address" name="city" placeholder="castletown" required><br>
            <input type="text" id="address" name="county" placeholder="Co.dublin" required><br>
            <input type="text" id="address" name="zipCode" placeholder="1A2B3C4" required><br>
